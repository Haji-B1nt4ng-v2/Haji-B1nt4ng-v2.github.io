...
<div style="border: 1px orangered; solid; padding: 10px; background-color:orangered; text-align: left"><center><font size="5"><font color="white">Instagram Followers</font></font></center> </div>
...
<div style="width:100%" class="form-group">
  <input type="submit" name="gsubmit" class="btn btn-block" style="color: #ffffff;background-color:darkred;" id="gsubmit" value="Verify"> </form>
